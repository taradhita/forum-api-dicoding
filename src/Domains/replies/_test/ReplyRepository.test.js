...
describe('ReplyRepository interface', () => {
  it('should throw error when invoke abstract behavior', async () => {
    ...
    await expect(replyRepository.checkIfReplyExist({})).rejects.toThrowError('REPLY_REPOSITORY.METHOD_NOT_IMPLEMENTED');
    await expect(replyRepository.verifyReplyByUser({})).rejects.toThrowError('REPLY_REPOSITORY.METHOD_NOT_IMPLEMENTED');
